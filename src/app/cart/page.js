      ...
      <div className="min-h-screen flex flex-col bg-gray-100">
        ...
        <main className="flex-grow flex items-center justify-center text-center px-4 py-20">
          <div className="max-w-md mx-auto">
            ...
            <Link
              href="/"
              className="inline-block bg-black hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg transition"
            >
              Continue Shopping
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-white rounded-xl shadow-xl p-6 h-fit sticky top-28">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <button
                className="w-full bg-black hover:bg-gray-700 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition duration-150 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-100 focus:ring-opacity-50"
